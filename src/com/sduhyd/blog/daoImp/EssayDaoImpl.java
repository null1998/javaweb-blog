...
public class EssayDaoImpl{
  ...
  */
    ...
    public static void addStar(Integer essay_id,Integer number){
        addOrSubAttr(true,"star",essay_id,number);
    }
    public static void subStar(Integer essay_id,Integer number){
        addOrSubAttr(false,"star",essay_id,number);
    }

    public static void addDiss(Integer essay_id,Integer number){
        addOrSubAttr(true,"diss",essay_id,number);
    }
    public static void subDiss(Integer essay_id,Integer number){
        addOrSubAttr(false,"diss",essay_id,number);
    }

    public static void addFavorite(Integer essay_id,Integer number){
        addOrSubAttr(true,"favorite",essay_id,number);
    }
    ...
    public static void addComments(Integer essay_id,Integer number){
        addOrSubAttr(true,"comments",essay_id,number);
    }
    public static void subComments(Integer essay_id,Integer number){
        addOrSubAttr(false,"comments",essay_id,number);
    }
    /**
