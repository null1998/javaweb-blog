...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="/BaseServlet/auth/logOut"><span class="glyphicon glyphicon-arrow-right"></span>退出</a></li>
            </ul>
            <ul class="nav navbar-nav navbar-right">
                <li><a href="/BaseServlet/auth/showFavorite"><span class="glyphicon glyphicon-star"></span>收藏</a></li>
            </ul>
            <ul class="nav navbar-nav navbar-right">
                <li><a href="/BaseServlet/auth/loadWriteEssayPage"><span class="glyphicon glyphicon-edit"></span>写文章</a></li>
            </ul>
        </div>
    </div>
</nav>
